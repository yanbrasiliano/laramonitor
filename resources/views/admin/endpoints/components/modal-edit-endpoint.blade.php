        ...
        @component('admin.endpoints.components.partials.modal-common', [
            ...
            @slot('content')
                <form id="edit-endpoint-form">
                    <input type="hidden" id="endpoint-id" name="id" value="">
                    <input type="text" id="endpoint-edit-url" name="url" placeholder="Enter endpoint URL"
                        class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        required>
                    <div class="mt-4">
                        <input type="number" id="endpoint-edit-frequency" name="frequency" placeholder="Frequency (in minutes)"
                            min="1" step="1"
