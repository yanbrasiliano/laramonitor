...
<head>
    ...
    <title>Website Monitor - Laravel</title>
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="text-center">
                <h1 class="font-bold leading-tight text-gray-900 dark:text-white mb-6" style="font-size: 6rem;">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300">
                    Your one-stop solution for real-time monitoring of websites and web services.
                </p>
            </div>
